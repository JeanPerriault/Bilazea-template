...
Element.implement(
{
  reflect:function(b)
  {
    ...
    if(a.get("tag")=="img")
    {
      ...
      function c()
      {
    	var f=a.width,d=a.height,k,h,l,g,j;
    	...
    	else
    	{
    	  ...
    	  try{
    		...
    		g.fillStyle=j;g.rect(0,0,f,h);
    		g.fill()
          }
    	  catch(i){return}
    	}
    	k.setStyles({display:"block",border:0});
    	l=new Element(($(a.parentNode).get("tag")=="a")?"span":"div").injectAfter(a).adopt(a,k);
    	l.className=a.className;a.store("reflected",l.style.cssText=a.style.cssText);
